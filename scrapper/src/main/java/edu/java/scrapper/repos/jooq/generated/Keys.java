...
package edu.java.scrapper.repos.jooq.generated;
...
import edu.java.scrapper.repos.jooq.generated.tables.records.ChatLinkRecord;
import edu.java.scrapper.repos.jooq.generated.tables.records.ChatRecord;
...
public class Keys {
    ...
    public static final UniqueKey<ChatRecord> CONSTRAINT_1F =
        Internal.createUniqueKey(Chat.CHAT, DSL.name("CONSTRAINT_1F"), new TableField[] {Chat.CHAT.NAME}, true);
    public static final UniqueKey<ChatLinkRecord> ID = Internal.createUniqueKey(ChatLink.CHAT_LINK,
        DSL.name("ID"),
